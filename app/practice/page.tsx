...
type AnswerInsert = {
  ...
  async function ensureAuthAndLoad() {
    ...
    if (!list.length) {
      setErr("No questions returned. Check that questions exist for this subject/subskill.");
      setQuestions([]);
      return;
    }
  ...
  return (
    <main className="min-h-screen p-6 max-w-3xl mx-auto">
      ...
      <div className="mt-6 text-xs text-gray-500">
        MVP note: answers are saved at the end of the session. Leaderboards/skills update after finishing.
      </div>
    </main>
  );
}
